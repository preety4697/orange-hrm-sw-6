...
public class UserSteps {
    ...
    public void iEnterPasswordJohnInPasswordField(String arg0) {
        new AddUserPage().enterPassword("John");

    }

    @And("I enter Confirm Password  {string}")
    public void iEnterConfirmPasswordJohn(String arg0) {
    ...
    public void iEnterUsernameJohnsmithInUsernameField(String arg0) {
